...
#define setcarry() P |= F_C
#define clearcarry() P &= (~F_C)
#define setzero() P |= F_Z
#define clearzero() P &= (~F_Z)
#define setinterrupt() P |= F_I
#define clearinterrupt() P &= (~F_I)
#define setdecimal() P |= F_D
#define cleardecimal() P &= (~F_D)
#define setoverflow() P |= F_V
#define clearoverflow() P &= (~F_V)
#define setsign() P |= F_N
#define clearsign() P &= (~F_N)
